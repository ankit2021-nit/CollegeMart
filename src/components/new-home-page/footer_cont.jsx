    ...
    <div className="flex flex-row justify-around  p-9 cursor-pointer">
      ...
      <footer className="bg-neutral-200 text-center text-white dark:bg-neutral-600 my-auto ">
        ...
        <div className="bg-neutral-300 p-4 text-center text-neutral-700 dark:bg-neutral-700 dark:text-neutral-200">
          ...
          <br />
          All rights reserved by - <a className="text-neutral-800 dark:text-neutral-400 hover:text-blue-600" href="https://www.linkedin.com/in/ankit-prasad-71175a195/" target="_blank" rel="noopener noreferrer">Ankit Prasad</a>
        </div>
      </footer>
