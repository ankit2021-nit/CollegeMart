...
const Footer = () => {
  ...
  <div className="w-full md:w-4/12 px-4 mx-auto text-center">
    <div className="text-sm text-blueGray-500 font-semibold py-1">
      © 2023 College Mart. All rights reserved by - <a href="https://www.linkedin.com/in/ankit-prasad-71175a195/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600">Ankit Prasad</a>, <a href="https://www.linkedin.com/in/kumar1397/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600">ISHWAR KUMAR SAHU</a>
    </div>
  </div>
</div>
